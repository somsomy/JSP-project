...
<tr><td class="tdtd">작성자</td><td class="tdtd"><input type="text" name="name" value="<%=mb.getName()%>" id="writer" readonly></td>
<td id="readtd">고양이 이름</td><td><input type="text" name="catName" value="<%=cb.getCatName() %>" id="cnametd" readonly></td>
</tr>
 <tr class="subsub"><td class="consub">글내용</td><td colspan="3" id="con"><textarea name="content" placeholder="내용을 입력해주세요." id="conupdate" required></textarea></td></tr>
</table>
<div class="clear"></div>
<div id="wbtn">
