...
for(int i = 0; i <cbList.size(); i++) {
	...
	%>
	<table>
	<tr><td rowspan="2" id="catimg"><img src="../images/uploadImage/<%=cb.getFileRealName()%>" width="300" height="300"></td>
	<td>안녕하새오! 나는 <span id="catName"><%=cb.getCatName() %></span> 이애옹.</td>
	<td><input type="button" value="고양이 정보" class="supBtn" onclick="location.href='supportContent.jsp?catId=<%=cb.getCatId() %>'" ></td></tr>
	<tr><td class="info">입소날짜 : <%=cb.getCatDate() %> | 나이 : <%=cb.getCatAge() %></td>
