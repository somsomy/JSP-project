...
List<FoundBoardBean> fbbList=fbdao.getBoardList(startRow,pageSize);
...
<a href="catFound.jsp?pageNum=<%=startPage-pageBlock%>">이전</a>
<%} 
for(int i=startPage;i<=endPage;i++){
	%>
	<a href="catFound.jsp?pageNum=<%=i%>"><%=i %></a>
	<%
}
%>
<%
if(endPage < pageCount){
	%>
	<a href="catFound.jsp?pageNum=<%=startPage+pageBlock%>">다음</a>
	<%
}
%>
</div>
