...
List<FindBoardBean> fbbList=fbdao.getBoardList(startRow, pageSize, search);
...
<a href="catFindSearch.jsp?pageNum=<%=startPage-pageBlock%>">이전</a>
<%} 
for(int i=startPage;i<=endPage;i++){
	%>
	<a href="catFindSearch.jsp?pageNum=<%=i%>"><%=i %></a>
	<%
}
%>
<%
if(endPage < pageCount){
	%>
	<a href="catFindSearch.jsp?pageNum=<%=startPage+pageBlock%>">다음</a>
	<%
}
%>
</div>
